...
class packingScreenController extends GetxController {
  ...
  Future<void> scanBarcode() async {
    ...
    final decode = jsonDecode(barcodeScanRes.toString());
    update();
    ...
    // };
    //
    //final decode = jsonDecode(jsonEncode(barcodeScanRes.toString()));

    //print("DATA - >${decode["Header Item"]}");

    if(decode["Header Item"].toString()=="000001"){
      secBundalScreen.add(
          BundalScreen(
              decode["Header Item"].toString(),//productCode,
              decode["ItemCode"].toString(),//itemCode,
              formatter.toString(),//date,
              decode["No of Sheets"].toString(),//varible1,
              "No of Sheets",//varible1Name,
              decode["Quality"].toString(),//varible2,
              "Quality",//varible2Name,
              decode["Density"].toString(),//varible3,
              "Density",//varible3Name,
              decode["Length"].toString(),//varible4,
              "Length",//varible4Name,
              decode["Width"].toString(),//varible5,
              "Width",//varible5Name,
              decode["Thickness"].toString(),//varible6,
              "Thickness",//varible6Name,
              decode["Weight"].toString(),//varible7,
              "Weight",//varible7Name,
              "",//varible8,
              "",//varible8Name,
              "",//varible9,
              ...
              "",// varible11,
              "",//varible11Name,
              decode["StorageBayNo"].toString(),//storagePayNo,
              decode["QRDocEntry"].toString(),//qrdocEntry,
              decode["LineID"].toString(),//lineID,
    ...
    else if(decode["Header Item"].toString()=="000002"){}
    else if(decode["Header Item"].toString()=="000003"){}
    else if(decode["Header Item"].toString()=="000004"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          formatter.toString(),//date,
          decode["GSM"].toString(),//varible1,
          "GSM",//varible1Name,
          decode["Width"].toString(),//varible2,
          "Width",//varible2Name,
          decode["Length"].toString(),//varible3,
          "Length",//varible3Name,
          decode["Colour"].toString(),//varible4,
          "Colour",//varible4Name,
          decode["Grade"].toString(),//varible5,
          "Grade",//varible5Name,
          decode["Lamination"].toString(),//varible6,
    ...
    else if(decode["Header Item"].toString()=="000005"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
            formatter.toString(),//date,
          decode["Micron"].toString(),//varible1,
          "Micron",//varible1Name,
          decode["Width"].toString(),//varible2,
          "Width",//varible2Name,
          decode["Length"].toString(),//varible3,
          ...
          decode["Colour"].toString(),//varible4,
          "Colour",//varible4Name,
          decode["Weight"].toString(),//varible5,
          "Weight",//varible5Name,
          "",//varible6,
          "",//varible6Name,
          "",//varible7,
    ...
    else if(decode["Header Item"].toString()=="000006"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
            formatter.toString(),//date,
          decode["Quality"].toString(),//varible1,
          "Quality",//varible1Name,
          decode["Length"].toString(),//varible2,
          "Length",//varible2Name,
          decode["Width"].toString(),//varible3,
          "Width",//varible3Name,
          decode["Thickness"].toString(),//varible4,
    ...
    else if(decode["Header Item"].toString()=="000007"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000008"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000009"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          ...
          decode["Quality"].toString(),//varible1,
          "Quality",//varible1Name,
          decode["Quantity"].toString(),//varible2,
          "Quantity",//varible2Name,
          decode["Weight"].toString(),//varible3,
          "Weight",//varible3Name,
          "",//varible4,
          "",//varible4Name,
          "",//varible5,
    ...
    else if(decode["Header Item"].toString()=="000010"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          ...
          decode["Quality"].toString(),//varible1,
          "Quality",//varible1Name,
          decode["Colour"].toString(),//varible2,
          "Colour",//varible2Name,
          decode["Quantity"].toString(),//varible3,
          "Quantity",//varible3Name,
          decode["Weight"].toString(),//varible4,
          "Weight",//varible4Name,
          "",//varible5,
          "",//varible5Name,
          "",//varible6,
    ...
    else if(decode["Header Item"].toString()=="000011"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000012"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          ...
          decode["Quantity"].toString(),//varible2,
          "Quantity",//varible2Name,
          decode["TypeOfCan"].toString(),//varible3,
    ...
    else if(decode["Header Item"].toString()=="000013"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          formatter.toString(),//date,
          decode["Density"].toString(),//varible1,
          "Density",//varible1Name,
          decode["Quality"].toString(),//varible2,
          "Quality",//varible2Name,
          decode["Length"].toString(),//varible3,
          "Length",//varible3Name,
          decode["Width"].toString(),//varible4,
          "Width",//varible4Name,
          decode["Thickness"].toString(),//varible5,
          "Thickness",//varible5Name,
          decode["Walling"].toString(),//varible6,
          "Walling",//varible6Name,
          decode["Hessain"].toString(),//varible7,
          "Hessain",//varible7Name,
          decode["Quantity"].toString(),//varible8,
          "Quantity",//varible8Name,
          decode["Weight"].toString(),//varible9,
          "Weight",// varible9Name,
          "",// varible10,
          "",//varible10Name,
          "",// varible11,
    ...
    else if(decode["Header Item"].toString()=="000014"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000015"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          ...
          decode["Quality"].toString(),//varible1,
          "Quality",//varible1Name,
          decode["GSM"].toString(),//varible2,
          "GSM",//varible2Name,
          decode["Width"].toString(),//varible3,
          "Width",//varible3Name,
          decode["Length"].toString(),//varible4,
          "Length",//varible4Name,
          decode["Quantity"].toString(),//varible5,
          "Quantity",//varible5Name,
          decode["Weight"].toString(),//varible6,
          "Weight",//varible6Name,
          "",//varible7,
          "",//varible7Name,
          "",//varible8,
    ...
    else if(decode["Header Item"].toString()=="000016"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000017"){
      ...
      secBundalScreen.add(
        BundalScreen(
          ...
          decode["Width"].toString(),//varible3,
          "Width",//varible3Name,
          decode["PVCpillow"].toString(),//varible4,
          "PVCpillow",//varible4Name,
          decode["PillowCover"].toString(),//varible5,
    ...
    else if(decode["Header Item"].toString()=="000018"){}
    else if(decode["Header Item"].toString()=="000019"){}
    else if(decode["Header Item"].toString()=="000020"){}
    else if(decode["Header Item"].toString()=="000021"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000022"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000023"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          ...
          decode["Quality"].toString(),//varible1,
          "Quality",//varible1Name,
          decode["Density"].toString(),//varible2,
    ...
    else if(decode["Header Item"].toString()=="000024"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000025"){}
    else if(decode["Header Item"].toString()=="000026"){}
    else if(decode["Header Item"].toString()=="000027"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          formatter.toString(),//date,
          decode["Thickness"].toString(),//varible1,
          "Thickness",//varible1Name,
          decode["Height"].toString(),//varible2,
          "Height",//varible2Name,
          decode["Turns"].toString(),//varible3,
          "Turns",//varible3Name,
          decode["CoilStructure"].toString(),//varible4,
          "CoilStructure",//varible4Name,
          decode["Length"].toString(),//varible5,
          "Length",//varible5Name,
          decode["Width"].toString(),//varible6,
          "Width",//varible6Name,
          decode["Weight"].toString(),//varible7,
          "Weight",//varible7Name,
          "",//varible8,
    ...
    else if(decode["Header Item"].toString()=="000028"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000029"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000030"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000031"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
    ...
    else if(decode["Header Item"].toString()=="000042"){
      secBundalScreen.add(
        BundalScreen(
          decode["Header Item"].toString(),//productCode,
          decode["ItemCode"].toString(),//itemCode,
          ...
          decode["Quality"].toString(),//varible1,
          "Quality",//varible1Name,
          decode["Emboss"].toString(),//varible2,
          "Emboss",//varible2Name,
          decode["Cloth"].toString(),//varible3,
          "Cloth",//varible3Name,
          decode["Finish"].toString(),//varible4,
          "Finish",//varible4Name,
          decode["Color"].toString(),//varible5,
          "Color",//varible5Name,
          decode["Thickness"].toString(),//varible6,
          "Thickness",//varible6Name,
          decode["Tone"].toString(),//varible7,
          "Tone",//varible7Name,
          decode["Width"].toString(),//varible8,
          "Width",//varible8Name,
          decode["Quantity"].toString(),//varible9,
          "Quantity",// varible9Name,
          decode["Grade"].toString(),// varible10,
          "Grade",//varible10Name,
          decode["Weight"].toString(),// varible11,
