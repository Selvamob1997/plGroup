...
class ScaningQrcodePage extends GetView<ScaningQrcodeController> {
  @override
  Widget build(BuildContext context)=>GetBuilder<ScaningQrcodeController>(builder: (dispatchCntrlr) {
